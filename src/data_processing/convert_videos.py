...
VIDEOS_TO_CONVERT_DIR = r'data_processing\videos_to_convert'
CONVERTED_VIDEOS_DIR = r'data_processing\converted_videos'
...
def crop_frame(image,crop_dim = DEFAULT_CROP_DIM):
...
if __name__ == '__main__':
    cwd = os.getcwd()
    list_videos = os.listdir(os.path.join(cwd, VIDEOS_TO_CONVERT_DIR))
    output_folder = os.path.join(cwd, CONVERTED_VIDEOS_DIR)
    for video_path in list_videos:
        video_path = os.path.join(cwd, VIDEOS_TO_CONVERT_DIR, video_path)
