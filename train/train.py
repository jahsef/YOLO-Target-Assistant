...
def main():
    ...
    cwd = os.getcwd()
    data_yaml_path = os.path.join(cwd,'train//datasets/EFPS_4000img_640x640//data.yaml')  # Update with your data.yaml path
    print(data_yaml_path)

    epochs = 100  # Adjust the number of epochs as needed
    batch = 24 # Adjust based on your GPU memory
    nbs = 24 #nominal/effective batch size, updates gradients every 4 iterations (24/6)
    ...
    model.train(
        ...
        resume = False,
        device = 0,
        name='EFPS_11n_4000img_640x640_batch24_nd',  # Directory name for the run
